...
export default async function Page() {
  const { page } = await getPageData('industries-legal')
  if (!page) notFound()
    ...
    <>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-950 to-gray-950 text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-3">{hero.badge || ''}</p>
      ...
      {/* CTA */}
      <section className="py-20 bg-gradient-to-br from-slate-950 to-gray-950 text-white text-center">

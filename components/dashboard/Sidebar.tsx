...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 min-h-screen flex flex-col" style={{background: 'linear-gradient(180deg, #592b77 0%, #2F3B40 100%)'}}>
      {/* Logo */}
      <div className="px-6 py-5 border-b border-white/10">
        ...
        <p className="text-white/50 text-xs mt-1 tracking-widest font-heading">AGENCY DASHBOARD</p>
      </div>
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-heading tracking-wider transition-all duration-150 ${
                isActive
